...
from ..llava_arch2 import LlavaSpatialMetaModel, LlavaSpatialMetaForCausalLM
...
class LlavaQwenSpatialConfig(Qwen2Config):
    model_type = "llava_qwen_spatial"


class LlavaQwenSpatialModel(LlavaSpatialMetaModel, Qwen2Model):
    config_class = LlavaQwenSpatialConfig

    def __init__(self, config: Qwen2Config):
        super(LlavaQwenSpatialModel, self).__init__(config)


class LlavaQwenSpatialForCausalLM(Qwen2ForCausalLM, LlavaSpatialMetaForCausalLM):
    config_class = LlavaQwenSpatialConfig
    ...
    def __init__(self, config):
        ...
        self.model = LlavaQwenSpatialModel(config)
...
AutoConfig.register("llava_qwen_spatial", LlavaQwenSpatialConfig)
AutoModelForCausalLM.register(LlavaQwenSpatialConfig, LlavaQwenSpatialForCausalLM)